...
if ssh root@OMITTED "ls -laFh /root/backup*" | grep failed > xenbackup_fail.mail; then
	...
	cat xenbackup_fail.mail | mail -s "XenBackup ran and failed now or in the past. If I'm wrong or wasting your attention, feel free to edit me at $SCRIPTPATH on $hostname" me@jelec.com
else
